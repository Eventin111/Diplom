...
После завершения разработки платформа **SwipeIt** стала выпускной квалификационной работой, успешно защищённой на оценку **«отлично»**.

![](https://github.com/Eventin111/SwipeIt/blob/Frontend-Backend-ML/image/Banner-Afisha-Studencheskiy-startap.jpg)
В дальнейшем проект получил развитие в рамках участия в федеральном конкурсе **«Студенческий стартап»**. Конкурс проводится Фондом содействия инновациям в рамках Платформы университетского технологического предпринимательства и направлен на поддержку студенческих технологических проектов с высоким потенциалом коммерциализации. Победители конкурса получают грантовую поддержку для дальнейшего развития своих решений.

Проект **SwipeIt** был представлен на конкурс в качестве технологического стартапа, объединяющего социальную платформу и технологии искусственного интеллекта для виртуальной примерки одежды.

> 📌 **Результаты участия в конкурсе будут опубликованы после подведения итогов (ориентировочно — середина июля).**

## Основные возможности платформы

![](https://github.com/Eventin111/SwipeIt/blob/Frontend-Backend-ML/image/Результат%20примерки.png)
